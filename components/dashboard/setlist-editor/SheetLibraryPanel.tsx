...
export default function SheetLibraryPanel({ sheets, teamId, addedSheetIds, onAdd }: SheetLibraryPanelProps) {
  ...
  return (
    <section className="bg-white border rounded-lg p-4 md:p-6 flex flex-col gap-4 min-h-0">
      <div>
        <h2 className="text-lg font-semibold mb-3">악보 라이브러리</h2>
